                        ...
                        <td>
                            <?php
                                 if($row['return_status']==''){
                                    ...
                                    echo '<span style="color:red"> <b> On Rent </b></span>';
                                }
                            ?>

                                <?php echo '<span style="color:red"> <b>'. $row['return_status'] .'</b></span>'; ?>
                                <br><br>
                                <?php
                                if($row['return_status']=='On rent' || $row['return_status']=='') {
                                  
                                    ?>
                                        <a href="return-change-status.php?id=<?php echo $row['id']; ?>&task=Returned" class="btn btn-warning btn-xs" style="width:100%;margin-bottom:4px;">
                                            Mark Returned
                                        </a>
                                    <?php
